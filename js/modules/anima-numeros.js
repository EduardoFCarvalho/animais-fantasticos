export default class AnimaNumeros {
  ...
  static incrementaNumero(numero) {
    // pode ser static pq não precisa de nenhum elemento de fora da função.
  ...
  animaNumeros() {
    this.numeros.forEach((numero) => this.constructor.incrementaNumero(numero)); // Como a função é static ela passa a ser parte do AnimaNumeros então precisa puxar pelo construtor
  }
